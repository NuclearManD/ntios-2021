...
#include "libneon.h"
#include "libneonmath.h"

double			*mtx2arr(double *dst, t_mtx *src)
{
	if (dst != NULL && src != NULL)
		memcpy(dst, src->mem, sizeof(double) * src->x_size * src->y_size);
	else
		return (NULL);
	return (dst);
}
...
{
	if (dst != NULL && src != NULL)
		memcpy(dst->mem, src, sizeof(double) * dst->x_size * dst->y_size);
	else
		return (NULL);
	return (dst);
}
...
{
	if (dst != NULL && src != NULL)
		memcpy(dst, src->vals, sizeof(double) * src->size);
	else
		return (NULL);
	return (dst);
}
...
{
	if (dst != NULL && src != NULL)
		memcpy(dst->vals, src, sizeof(double) * dst->size);
	else
		return (NULL);
	return (dst);
}
